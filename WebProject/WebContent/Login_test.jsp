		...
		<table>
			...
			<tr>
				<td colspan="3" align=center><br> <input type="submit"
					value="로그인" style="width: 250pt; height: 40pt;"> <!-- <input type="submit" value="로그인" <br> <br> </a><input
					type="button" value="아이디/비밀번호 찾기"
					onclick="location.href='Find ID password.html'"> <!-- 회원 정보 찾기 type 추후 변경 예정 -->
					<input type="button" name="" value="회원가입"
					onclick="location.href='UserInfo.html'"></td>
			</tr>
		</table>
	</form>
